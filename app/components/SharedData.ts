...
export const timeline: TimelineItem[] = [
  {
    semester: "7th Semester",
    period: "Current",
    title: "Production Systems & AI Integration",
    highlights: [
      "TickEasy - Event ticketing platform serving 2-3K+ users",
      "IKSS Blood Bot - Live automation for university community",
      "Eventure - AI-powered event management orchestrator",
  ...
  },
  {
    semester: "6th Semester",
    period: "2024",
    title: "Microservices & AI-Enhanced Platforms",
    highlights: [
      "EduVerse - AI learning platform with 5 microservices",
      "~100K lines of code, 150+ API endpoints",
      "Stripe payment integration & real-time features",
  ...
  },
  {
    ...
    highlights: [
      "E-Commerce App - Amazon-like features",
      "Multiplayer TicTacToe - Socket.IO learning",
  ...
  },
  {
    semester: "4th Semester",
    period: "2023",
    title: "First Large-Scale Mobile Development",
    highlights: [
      "Doctors Appointment App - First major project",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Offline messaging without internet",
      "SOS alerts & location sharing",
      "Bridgefy SDK implementation",
    ],
